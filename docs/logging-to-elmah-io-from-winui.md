...
howto_steps:
  - name: Install the Elmah.Io.WinUI package
    text: "dotnet add package Elmah.Io.WinUI --prerelease (or Install-Package Elmah.Io.WinUI -IncludePrerelease)."
  - name: Initialize elmah.io in App.xaml.cs
    text: "In the App constructor, call: ElmahIoWinUI.Init(new ElmahIoWinUIOptions(\"API_KEY\", new Guid(\"LOG_ID\"))); Replace API_KEY with your API key and LOG_ID with the id of the log where you want errors logged."
