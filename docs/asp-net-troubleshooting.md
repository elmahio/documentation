...
- If you are running on a .NET version older than 4.6, make sure to configure your application to use TLS 1.2 as seen here: [TLS 1.2 Requirement for api.elmah.io](tls-1-2-requirement-for-api-elmah-io.md).
