...
Replace `API_KEY` with your API key (<a href="/where-is-my-api-key/">Where is my API key?</a>) and `LOG_ID` (<a href="/where-is-my-log-id/">Where is my log ID?</a>) with the log Id of the log you want to log to.
